...
SECRET_KEY = 'django-insecure-m!_*e$wq-cc&a0_vvfm=^k_898z#$q$x7z@+jdd)s8o9p106ma'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Bait Tur Rizwan Software House  APIS',
    'DESCRIPTION': 'its My Company API documentations',
    'VERSION': '1.0.0',
}
